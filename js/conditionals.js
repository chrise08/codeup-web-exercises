...
// 	if (str === "red") {
// 		return "Red is the color of a fire engine.";
// 	} else if (str === "orange") {
...
// 	} else if (str === "indigo") {
// 		return "Indigo is a fancy purple.";
// 	} else if (str === "violet") {
// 		return "Violets aren't violet.";
// 	} else {
...
// console.log(analyzeColor("chartreuse"));
...
// var color = prompt("Tell me a color.").toLowerCase();
//
...
// console.log(calculateTotal(1, 99.99));
